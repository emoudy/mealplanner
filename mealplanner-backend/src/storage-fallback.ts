...
export class MemoryStorage implements IStorage {
  ...
  constructor() {
    // Only initialize with mock data in development environment
    if (process.env.NODE_ENV === 'development') {
      console.log('Development mode: Loading mock data for testing');
      ...
      // Load mock users (without passwords for security)
